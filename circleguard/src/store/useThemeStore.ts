...
import { LIGHT_THEME, DARK_THEME, GRAY_THEME, MINIMALIST_MONOCHROME_THEME, BAUHAUS_THEME, ThemeColors, LUXURY_THEME } from '../constants/theme';

export type ThemeMode = 'light' | 'dark' | 'gray' | 'minimalist_monochrome' | 'bauhaus' | 'system';
