...
export default function RotatingEarth({ width = 800, height = 600, className = "" }: RotatingEarthProps) {
  ...
  useEffect(() => {
    ...
    const containerWidth = typeof window !== "undefined" ? Math.min(width, window.innerWidth - 40) : width
    const containerHeight = typeof window !== "undefined" ? Math.min(height, window.innerHeight - 100) : height
