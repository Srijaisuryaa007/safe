...
const AnimatedList = ({
  ...
  const containerStyle = gradientColor ? { '--list-gradient-bg': gradientColor } : undefined;
  const listCustomStyle = maxHeight ? { maxHeight: typeof maxHeight === 'number' ? `${maxHeight}px` : maxHeight } : undefined;
